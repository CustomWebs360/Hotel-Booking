                                ...
                                <form class="auth-login-form mt-2" action="{{route('login')}}" method="POST">
                                    @csrf
                                      <div class="form-group">
                                        ...
                                        <input class="form-control" id="login-email"  type="email" name="email" value="admin@gmail.com" placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1"/>
                                        @error('email')
                                      ...
                                      <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge" type="password" value="12312312" name="password"   placeholder="············" aria-describedby="login-password" tabindex="2" />

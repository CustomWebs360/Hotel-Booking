  <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-shadow">
      <div class="navbar-container d-flex content">
          <div class="bookmark-wrapper d-flex align-items-center">
              ...
              <ul class="nav navbar-nav bookmark-icons">
                  ...
                  <li class="nav-item d-none d-lg-block"><a class="nav-link" href="app-todo.html" data-toggle="tooltip"
                          data-placement="top" title="Todo"><i class="ficon" data-feather="check-square"></i></a>
                  </li>
              </ul>
          ...
          <ul class="nav navbar-nav align-items-center ml-auto">
              ...
              {{-- <li class="nav-item d-none d-lg-block"><a href="{{route('admin.mode.change')}}" class="nav-link nav-link-style"><i class="ficon"
                          data-feather="moon"></i></a></li> --}}
              <li class="nav-item d-none d-lg-block"><a id="{{theme_setting()->setting_value == 'light-layout' ? 'light' : 'dark'}}" class="nav-link nav-link-style"><i class="ficon"
                          data-feather="{{theme_setting()->setting_value == 'light-layout' ? 'moon' : 'sun'}}"></i></a></li>
              ...
              <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user"><a
                      ...
                      <div class="dropdown-divider"></div><a class="dropdown-item"
                          ...
                          <a class="dropdown-item" onclick="document.getElementById('logOutForm').submit()"><i class="mr-50" data-feather="power"></i> Logout</a>
                  </div>
              </li>
          </ul>
      </div>
